...
class Identification extends Abstraction
{
    ...
    public function getSha(string $text, int $bits = 256): string
    {
    ...
    private function validateNewPersonCode(string $personCode): bool
    {
    ...
    private function validateOldPersonCode(string $personCode): bool
    {
